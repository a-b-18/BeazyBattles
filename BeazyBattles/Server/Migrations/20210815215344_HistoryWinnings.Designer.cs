...
namespace BeazyBattles.Server.Migrations
{
    ...
    [Migration("20210815215344_HistoryWinnings")]
    partial class HistoryWinnings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeazyBattles.Shared.Battle", b =>
                {
                    ...
                    b.Property<int>("AttackerWinnings")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OpponentWinnings")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BeazyBattles.Shared.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BeazyBattles.Shared.UserUnit", b =>
                {
                    b.HasOne("BeazyBattles.Shared.Unit", "Unit")
                        .WithMany()
                        .HasForeignKey("UnitId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BeazyBattles.Shared.User", null)
                        .WithMany("Units")
